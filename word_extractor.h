...
struct WordExtractorHolder {
	struct WordExtractor* dictionary;
	struct WordExtractor* text;
	char* dictionaryFile;
	char* textFile;
};
...
struct WordExtractorHolder *weCreateExtractorHolder(struct WordExtractor *dictExtractor, struct WordExtractor *wordExtractor, char* dictionary, char* textFile);
