...
//Create struct to hold to extractors, for void* argument

struct WordExtractorHolder *
weCreateExtractorHolder(struct WordExtractor *dictExtractor, struct WordExtractor *wordExtractor, char* dictionary, char* textFile)
{	
	struct WordExtractorHolder * we;
	we = (struct WordExtractorHolder *) malloc(sizeof(struct WordExtractorHolder));
	we->dictionary = dictExtractor;
	we->text = wordExtractor;
	we->dictionaryFile = dictionary;
	we->textFile = textFile;
